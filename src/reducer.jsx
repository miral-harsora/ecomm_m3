...
export const reducer = (state = INIT_STATE, action) => {
    switch (action.type) {
        case GET_PRODUCTS: {
                       return { ...state, products: action.payload.httpResponse.products.filter((product) => (product.category != "motorcycle" && product.category != "vehicle" && product.category != "groceries")) }
        }
        case GET_CATEGORIES: {
